...
public class ModItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.copy(ModTags.Blocks.ZULOAGAE_LOG_BLOCK, ModTags.Items.ZULOAGAE_LOG_ITEM);
        ...
        this.tag(ItemTags.LOGS_THAT_BURN)
                .addTag(ModTags.Items.ZULOAGAE_LOG_ITEM)
                .addTag(ModTags.Items.SIGILLARIA_LOG_ITEM);
